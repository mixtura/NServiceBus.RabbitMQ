namespace NServiceBus.Transport.RabbitMQ
{
    ...
    /// <summary>
    /// Following class is copy of <see cref="ConventionalRoutingTopology"/> with a little tweak to support prioritized queues.
    ...
    /// </list>
    /// </summary>
    class ConventionalRoutingWithPrioritySupportTopology : IRoutingTopology, IDeclareQueues, ISupportDelayedDelivery
    {
